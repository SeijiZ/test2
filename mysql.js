...
mainRouter.get("/search", function(req, res){
	...
	connect.query("SELECT * FROM "tabelname" WHERE lat BETWEEN " req.query.lat - diffValue " AND " req.query.lat + diffValue
		AND  lng BETWEEN " req.query.lng - diffValue " AND " req.query.lng + diffValue
		AND style == styleDicide(req.query.style),
		AND temperature == temperatureDecide(req.query.temperature),
